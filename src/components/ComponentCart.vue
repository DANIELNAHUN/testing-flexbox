<template>
  <div class="d-flex">
    <v-row justify="space-around">
      <v-card class="justify-md-center" max-width="320">
        <v-img
          max-height="200"
          max-width="100%"
        ...
        <v-card-text class="px-8">
          ...
          <div class="subtitle-2 font-weight-regular text-center my-5">
            You can now listen to millions of song, audiobooks, and podcasts on
            any device anywhere you like!
          </div>
          <div class="d-flex justify-space-between">
            <div class="d-flex align-center">
              <v-btn class="ma-2" icon text>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" class="text-none">Proceed to Payment</v-btn>
          <v-spacer></v-spacer>
        </v-card-actions>
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="grey" text class="caption text-none"
            >Cancel Order</v-btn
          >
          <v-spacer></v-spacer>
        </v-card-actions>
